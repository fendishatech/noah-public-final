<div class="mt-8 p-2 bg-gradient-to-r from-gray-700 to-gray-600 shadow-lg rounded-lg  text-yellow-500 hiwua">
    <div class="p-6 rounded-lg border-2 border-yellow-500">
        <h2 class="text-4xl font-thin text-center">ክፍያዎች</h2>
