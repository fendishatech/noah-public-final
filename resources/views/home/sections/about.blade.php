            ...
            <div
                ...
                <svg fill="#000000" width="800px" height="800px" viewBox="0 0 24 24" id="target" data-name="Line Color"
                    ...
                    <path id="secondary" d="M15,9l-2.8,2.8M15,6V9h3l3-3H18V3Z"
                        style="fill: none; stroke: rgb(202, 138, 4); stroke-linecap: round; stroke-linejoin: round; stroke-width: 2;">
                    </path>
                    <path id="primary" d="M16.92,13A5.55,5.55,0,0,1,17,14a7,7,0,1,1-7-7,5.55,5.55,0,0,1,1,.08"
        ...
        <div class="flex items-center  mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div
                ...
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    viewBox="0 0 301.055 301.055" style="enable-background:new 0 0 301.055 301.055;"
                    xml:space="preserve">
                    <path
                        d="M189.798,31.551c0-4.143-3.357-7.5-7.5-7.5h-79.453c-4.143,0-7.5,3.357-7.5,7.5v47.687c0,4.143,3.357,7.5,7.5,7.5h71.953
